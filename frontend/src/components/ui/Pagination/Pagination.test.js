...
describe('Pagination Component', () => {
    it('renders correctly and shows the correct page number', () => {
        render(<Pagination currentPage={1} totalPages={5} handlePreviousPage={() => { }} handleNextPage={() => { }} />);
    ...
    it('disables the next page button on the last page', () => {
        render(<Pagination currentPage={5} totalPages={5} handlePreviousPage={() => { }} handleNextPage={() => { }} />);
        expect(screen.getByLabelText('Next page')).toBeDisabled();
    });

    it('enables both buttons on a middle page', () => {
        render(<Pagination currentPage={3} totalPages={5} handlePreviousPage={() => { }} handleNextPage={() => { }} />);
    ...
    it('calls handlePreviousPage when the previous page button is clicked', () => {
        ...
        render(<Pagination currentPage={2} totalPages={5} handlePreviousPage={handlePreviousPage} handleNextPage={() => { }} />);
    ...
    it('calls handleNextPage when the next page button is clicked', () => {
        ...
        render(<Pagination currentPage={2} totalPages={5} handlePreviousPage={() => { }} handleNextPage={handleNextPage} />);
